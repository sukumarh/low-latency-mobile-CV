...
public abstract class Classifier {
  ...
  public static class Result {
    ...
    public Result(final List<Recognition> recognitions, final long runtime) {
  ...
  public Result recognizeImage(final Bitmap bitmap, int sensorOrientation) {
    ...
    // Gets top-k results.
    return new Result(getTopKProbability(labeledProbability), endTimeForReference - startTimeForReference);
  }
